...
- Core Dump
  ...
  - lldb与llnode的使用
    ...
    ```bash
    ulimit -c unlimited
    node --abort-on-uncaught-exception xxx.js
    ```
    ...
    1. v8 bt
    2. v8 source list
    3. v8 findjsinstances
    4. v8 findobjects
    5. v8 findrefs
    6. v8 getactivehandles
    7. v8 getactiverequests
    8. v8 inspect
    9. v8 nodeinfo
  
    调试过程可以参见[这篇文章](https://zhuanlan.zhihu.com/p/58181765)
